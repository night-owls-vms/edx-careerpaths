#!/usr/bin/env python
"""
Package metadata for edx_careerpaths.
"""
import os
import re
import sys
...
VERSION = get_version('edx_careerpaths', '__init__.py')
...
setup(
    name='edx-careerpaths',
    version=VERSION,
    description="""This project is to manage careerpaths.""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Ted',
    author_email='kaungmyathtet.dev@gmail.com',
    url='https://github.com/night-owls-vms/edx-careerpaths',
    packages=find_packages(
        include=['edx_careerpaths', 'edx_careerpaths.*'],
        exclude=["*tests"],
    ),
    entry_points={
        'lms.djangoapp': [
            'careerpaths = edx_careerpaths.apps:EdxCareerpathsConfig',
        ],
    },
